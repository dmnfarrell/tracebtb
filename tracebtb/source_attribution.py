...
def get_herd_context(herd_no, metadata, parcels, moves):
    """
    ...
    neighbour_data = tools.find_neighbouring_points(metadata, sub, dist)
    # --- C. Movement Data ---
    # Get moves into this herd for all sampled animals
    herd_movements = tools.get_moves_bytag(sub, moves, lpis_cent).reset_index()
